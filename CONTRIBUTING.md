# Contributing to SpecLynx ApiDOM

Thank you for considering contributing to the SpecLynx ApiDOM!
This document outlines the process for contributing to the SpecLynx ApiDOM Repository.
...
3.  **Code & Test:** Write your code and add tests to cover your changes. Make sure the existing test suite passes.
  *   See [Development Section](https://github.com/speclynx/apidom?tab=readme-ov-file#development) of the main README file for setup instructions, testing commands, and development workflows.
...
-   **[🐛 Bug Report](https://github.com/speclynx/apidom/issues/new?assignees=&labels=bug&template=Bug_report.md&title=%5BBug%5D+)**
-   **[✨ Feature Request](https://github.com/speclynx/apidom/issues/new?assignees=&labels=enhancement&template=Feature_request.md&title=%5BFeature%5D+)**
...
Thank you for helping build and improve the SpecLynx ApiDOM!
