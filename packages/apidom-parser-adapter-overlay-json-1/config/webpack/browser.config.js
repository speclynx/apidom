...
const browser = {
  ...
  output: {
    ...
    filename: 'apidom-parser-adapter-overlay-json-1.browser.js',
    libraryTarget: 'umd',
    library: 'apidomParserAdapterOverlayJson1',
  },
  resolve: {
...
const browserMin = {
  ...
  output: {
    path: path.resolve('./dist'),
    filename: 'apidom-parser-adapter-overlay-json-1.browser.min.js',
    libraryTarget: 'umd',
    library: 'apidomParserAdapterOverlayJson1',
  },
  resolve: {
