...
`@speclynx/apidom-ns-json-schema-2020-12` contains ApiDOM namespace specific to [JSON Schema 2020-12](https://json-schema.org/draft/2020-12/draft-bhutton-json-schema-01) specification.
...
import jsonShema202012Namespace from '@speclynx/apidom-ns-json-schema-2020-12';
...
```js
import { JSONSchemaElement, LinkDescriptionElement } from '@speclynx/apidom-ns-json-schema-2020-12';
...
This package exposes [predicates](https://github.com/speclynx/apidom/blob/main/packages/apidom-ns-json-schema-2020-12/src/predicates.ts)
...
This package comes with its own [keyMap](https://github.com/speclynx/apidom/blob/main/packages/apidom-ns-json-schema-2020-12/src/traversal/visitor.ts#L11) and [nodeTypeGetter](https://github.com/speclynx/apidom/blob/main/packages/apidom-ns-json-schema-2020-12/src/traversal/visitor.ts#L4).
...
import { JSONSchemaElement, keyMap, getNodeType } from '@speclynx/apidom-ns-json-schema-2020-12';
...
```js
import { LinkDescriptionElement } from '@speclynx/apidom-ns-json-schema-2020-12';
...
import { refractorPluginReplaceEmptyElement, JSONSchemaElement } from '@speclynx/apidom-ns-json-schema-2020-12';
