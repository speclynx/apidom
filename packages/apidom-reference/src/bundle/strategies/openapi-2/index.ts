...
import { mediaTypes, isSwaggerElement } from '@speclynx/apidom-ns-openapi-2';

import File from '../../../File.ts';
import Reference from '../../../Reference.ts';
import ReferenceSet from '../../../ReferenceSet.ts';
import BundleStrategy, { BundleStrategyOptions } from '../BundleStrategy.ts';
import OpenAPI2BundleVisitor from './visitor.ts';
...
export type { OpenAPI2BundleVisitorOptions } from './visitor.ts';
export type {
 ...
 * @public
 */
export interface OpenAPI2BundleStrategyOptions extends Omit<BundleStrategyOptions, 'name'> {}

/**
 * @public
 */
class OpenAPI2BundleStrategy extends BundleStrategy {
  constructor(options?: OpenAPI2BundleStrategyOptions) {
...
export { OpenAPI2BundleVisitor };
export default OpenAPI2BundleStrategy;
