...
`@speclynx/apidom-ns-openapi-2` contains ApiDOM namespace supports following OpenAPI specification versions:
...
```js
import { SwaggerElement, InfoElement } from '@speclynx/apidom-ns-openapi-2';
...
This package exposes [predicates](https://github.com/speclynx/apidom/blob/main/packages/apidom-ns-openapi-2/src/predicates.ts)
for all higher order elements that are part of this namespace.

```js
import { isSwaggerElement, SwaggerElement } from '@speclynx/apidom-ns-openapi-2';
...
```js
import { InfoElement } from '@speclynx/apidom-ns-openapi-2';
...
import { refractorPluginReplaceEmptyElement, SwaggerElement } from '@speclynx/apidom-ns-openapi-2';
