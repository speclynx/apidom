...
describe('refractor', function () {
  context('plugins', function () {
    context('normalize-security-requirements', function () {
      context('given Swagger.security fixed field is defined', function () {
        context('and Operation.security is not defined', function () {
          specify(
            'should inherit Security Requirements from Swagger.security field',
            async function () {
        ...
        context('and Operation.security is defined as empty list', function () {
          specify(
            'should not inherit Security Requirements from Swagger.security field',
            async function () {
              const yamlDefinition = dedent`
              swagger: '2.0'
              security:
      ...
      context('given Swagger.security fixed field is not defined', function () {
