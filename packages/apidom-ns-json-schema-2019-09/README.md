# @speclynx/apidom-ns-json-schema-2019-09

`@speclynx/apidom-ns-json-schema-2019-09` contains ApiDOM namespace specific to [JSON Schema 2019-09](https://json-schema.org/draft/2019-09/draft-handrews-json-schema-02) specification.
...
JSON Schema 2019-09 namespace consists of [number of elements](https://github.com/speclynx/apidom/tree/main/packages/apidom-ns-json-schema-2019-09/src/elements) implemented on top
of [primitive ones](https://github.com/speclynx/apidom/tree/main/packages/apidom-datamodel/src/primitives).

```js
import { Namespace } from '@speclynx/apidom-datamodel';
import jsonSchema201909Namespace from '@speclynx/apidom-ns-json-schema-2019-09';

const namespace = new Namespace().use(jsonSchema201909Namespace);
...
```js
import { JSONSchemaElement, LinkDescriptionElement } from '@speclynx/apidom-ns-json-schema-2019-09';
...
This package exposes [predicates](https://github.com/speclynx/apidom/blob/main/packages/apidom-ns-json-schema-2019-09/src/predicates.ts)
for all higher order elements that are part of this namespace.

```js
import { isJSONSchemaElement, JSONSchemaElement } from '@speclynx/apidom-ns-json-schema-2019-09';
...
This package comes with its own [keyMap](https://github.com/speclynx/apidom/blob/main/packages/apidom-ns-json-schema-2019-09/src/traversal/visitor.ts#L11) and [nodeTypeGetter](https://github.com/speclynx/apidom/blob/main/packages/apidom-ns-json-schema-2019-09/src/traversal/visitor.ts#L4).
...
import { JSONSchemaElement, keyMap, getNodeType } from '@speclynx/apidom-ns-json-schema-2019-09';
...
```js
import { refractLinkDescription } from '@speclynx/apidom-ns-json-schema-2019-09';
...
import { refractorPluginReplaceEmptyElement, refractJSONSchema } from '@speclynx/apidom-ns-json-schema-2019-09';
