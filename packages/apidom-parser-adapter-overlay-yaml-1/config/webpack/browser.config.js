...
const browser = {
  ...
  output: {
    ...
    filename: 'apidom-parser-adapter-overlay-yaml-1.browser.js',
    libraryTarget: 'umd',
    library: 'apidomParserAdapterOverlayYaml1',
  },
  resolve: {
...
const browserMin = {
  ...
  output: {
    path: path.resolve('./dist'),
    filename: 'apidom-parser-adapter-overlay-yaml-1.browser.min.js',
    libraryTarget: 'umd',
    library: 'apidomParserAdapterOverlayYaml1',
  },
  resolve: {
